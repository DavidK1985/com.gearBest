...
import katzevman_David.com.gearBest.Infra.config.MainConfig;
 ...
 public class ProductsDiscountTesting extends AbstractTest {
...
//		Thread.sleep(1000);
		...
		// Step 6 - product page discount Check
		report.startLevel("Step 6 - click on product number "+(resultNumber+1)+" and see if there is a discount");
